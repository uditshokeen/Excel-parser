...
# Route to form and upload the file
@app.route('/')
def upload_form():
    return '''
...
def handle_file():
    ...
    try:
        # Specify the engine explicitly and fill merged cell values
        df = pd.read_excel(filepath, engine='openpyxl')
        
        # Forward-fill and backward-fill missing values to handle merged cells
